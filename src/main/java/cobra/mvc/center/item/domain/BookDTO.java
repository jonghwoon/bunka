...
public class BookDTO {
	...
	public String toString() {
		return "BookDTO [book_id=" + book_id + ", book_isbn=" + book_isbn + ", book_title=" + book_title
				+ ", book_origin=" + book_origin + ", book_author=" + book_author + ", book_trans=" + book_trans
				+ ", book_publisher=" + book_publisher + ", book_publishdate=" + book_publishdate + ", book_incomedate="
				+ book_incomedate + ", book_categorybig=" + book_categorybig + ", book_categorymid=" + book_categorymid
				+ ", catbig=" + catbig + ", catmid=" + catmid + ", book_library=" + book_library + ", book_value="
				+ book_value + ", book_keyword=" + book_keyword + ", book_img=" + book_img + ", book_index="
				+ book_index + ", book_img_path=" + book_img_path + "]";
	}

	private String book_id;					//책 고유번호
