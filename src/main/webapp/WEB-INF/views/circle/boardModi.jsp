...
<body onload="loadPage('menu_load','menu_top.common');">		
    ...
    <div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
      <ul class="nav navbar-nav">
		...
		<c:if test="${cnt != 0}">
	 	<form action="boardModiPro.circle">
        <div class="container">
            <hr>
	 ...
	 <c:if test="${cnt == 0}">
	 	<script type="text/javascript">
	 		alert("비밀번호가 맞지 않습니다.");
	 		window.location='viewContents.circle?num=${param.num}&subject=${param.subject}&contents=${param.contents}&writer=${param.writer}&readCnt=${param.readCnt}&adddate=${param.adddate}';
	 	</script>
	 	</c:if>
</body>
</html>