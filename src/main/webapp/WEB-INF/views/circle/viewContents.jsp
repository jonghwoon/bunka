                          ...
                          <tr>
                             <td>
                               <span style='float:center'>
                                   <a href="board.circle"><button type="button" id="list" class="btn btn-default">목록</button></a>
                                   <input type="button" id="modi" value="수정" class="btn btn-default" onclick="del('boardModi.circle')">
                                   <input type="button" id="delete" value="삭제" class="btn btn-default" onclick="del('boardDel.circle')">
                               </span>
                             </td>
                          </tr>
                      </thead>
