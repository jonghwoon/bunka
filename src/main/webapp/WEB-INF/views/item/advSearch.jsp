<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%@ include file="setting.jsp" %>
        ...
        <body onload="loadPage('menu_load','menu_top.common');">
            ...
            <div class="col-md-7">
                <form id="form1" name="form1" class="form-horizontal" action="resultBook.item"
                	method="post">
                    <fieldset>
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="radius">도서관 선택</label>
                            <div class="col-md-2">
                        ...
                        <!-- 제목 -->
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="location">제목</label>
                            <div class="col-md-3">
                                <input id="location" name="location" type="text" placeholder="제목" class="form-control input-md">
                            </div>
                            <div class="col-md-1">
                        ...
                        <!-- 저자 -->
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="location">저자</label>
                            <div class="col-md-3">
                                <input id="location" name="location" type="text" placeholder="저자" class="form-control input-md">
                            </div>
                            <div class="col-md-1">
                                <select id="operator2" name="operator2" class="form-control">
						      <option value="1">AND</option>
						      <option value="2">OR</option>
						      <option value="3">NOT</option>
						    </select>
                        ...
                        <!-- 출판사 -->
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="location">출판사</label>
                            <div class="col-md-3">
                        ...
                        <!-- 날짜 -->
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="selectbasic">발행일</label>
                            <div class="col-md-2">
                                <input id="fromDate" type="text" placeholder="시작" class="form-control input-md">
                            </div>
                            <div class="col-md-2">
                            	<input id="toDate" type="text" placeholder="끝" class="form-control input-md">
                            </div>
                        </div>
                        <script type="text/javascript">
                            $(function() {
                        ...
                        <!-- 인라인 폼 -->
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="categoryb">대분류</label>
                            <div class="col-md-2">
                            ...
                            <label class="col-md-1 control-label" for="categorym">중분류</label>
                            <div class="col-md-2">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8 text-center">
                                <button id="submit" name="submit" class="btn btn-primary">검색</button>
                                <input type="reset" class="btn btn-danger" value="초기화">
                                <button class="btn btn-default" onclick="goBack();">이전</button>
                            </div>
                        </div>
