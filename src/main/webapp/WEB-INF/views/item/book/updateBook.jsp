<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <body onload="loadPage('menu_load','menu_top.common');">
        ...
        <br><br>
            ...
            <div class="col-md-9">
                <form action="updateBookPro.item" method="post"
                 ...
                 onsubmit="return bookInsertCheck();">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                            <select id="library" name="library" class="form-control" disabled="disabled">
						      <option>도서관</option>
						    </select>
                            </div>
                            <!-- 수량 -->
                            ...
                            <div class="col-md-2">
                                <input id="value" name="value" value="1" type="number" class="form-control input-md" disabled="disabled">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <input id="title" name="title" type="text" placeholder="제목" class="form-control input-md" value="${dto.book_title}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <input id="origin" name="origin" type="text" placeholder="원서명" class="form-control input-md" value="${dto.book_origin}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <input id="author" name="author" type="text" placeholder="저자" class="form-control input-md" value="${dto.book_author}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <input id="trans" name="trans" type="text" placeholder="역자" class="form-control input-md" value="${dto.book_trans}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <input id="publisher" name="publisher" type="text" placeholder="출판사" class="form-control input-md" value="${dto.book_publisher}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <input id="keyword" name="keyword" type="text" placeholder="키워드" class="form-control input-md" value="${dto.book_keyword}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <input id="isbn" name="isbn" type="text" placeholder="ISBN" class="form-control input-md" value="${dto.book_isbn}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <input id="publishDate" name="publishDate" type="text" placeholder="발행일" class="form-control input-md" value="${dto.book_publishdate}">
                            </div>
                            <!-- 입고일 -->
                            <label class="col-md-1 control-label" for="incomedate">반입일</label>
                            <div class="col-md-2">
                                <input id="incomedate" name="incomedate" type="text" placeholder="반입일" class="form-control input-md" value="${dto.book_incomedate}">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <textarea id="index" name="index" placeholder="목차" class="form-control input-md">
                                	${dto.book_index}
                                </textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <select id="selectbasic" name="selectbasic" class="form-control" onchange="subList(this.value)">
		                             <option value="${dto.book_categorybig}">대분류</option>
                            ...
                            <div class="col-md-2">
                             ...
                             <option value="${dto.book_categorymid}">중분류</option>
						    </select>
                            </div>
                        </div>
                        <!-- Button -->
