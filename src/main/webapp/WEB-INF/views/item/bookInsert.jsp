                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    <img src="" id="imagePreview" alt="Preview Image" width="120px" height="120px" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <input id="publishDate" type="text" placeholder="발행일" class="form-control input-md">
                            </div>
                            <!-- 입고일 -->
                            <label class="col-md-1 control-label" for="incomedate">반입일</label>
                            <div class="col-md-2">
                                <input id="incomedate" type="text" placeholder="반입일" class="form-control input-md">
                            </div>
