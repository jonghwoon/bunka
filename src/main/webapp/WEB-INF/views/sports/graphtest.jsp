...
<body onload="fresh()">
	<canvas id="demo" style="position: absolute;top : 100px;left : 100px"></canvas>
	<div style="position: absolute;top:100px;left:600px">
		<canvas id="demo" style="position: absolute;top : 100px;left : 100px"></canvas>
				<div style="position: absolute;top:100px;left:600px">
					
						<input type="hidden" id="STR" value="${dtos.str}" />
						<input type="hidden" id="AGI" value="${dtos.agi}" />
						<input type="hidden" id="MAG" value="${dtos.mag}" />
						<input type="hidden" id="HP" value="${dtos.hp}" />
						<input type="hidden" id="MP" value="${dtos.mp}" />
						<input type="hidden" id="DEF" value="${dtos.def}" />
