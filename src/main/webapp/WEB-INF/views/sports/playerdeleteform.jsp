...
<body>
	...
	<c:if test="${cnt != 0}">
	<form id="team" action="playerdelete.sports">
		<input type="hidden" name="delid" value="${param.id}">
		<fieldset>
			<legend>팀 삭제</legend>
			<ol>
				<li><label for="name">제명할 선수 이름</label> <input 
					name="name" type="text" value="${param.name}" required readonly></li>	
				<li><label for="id">아이디</label> <input 
					name="userid" type="text" value="${dto.id}" required readonly></li>
